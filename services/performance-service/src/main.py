...
_PERFORMANCE_SYSTEM_PROMPT_BASE = """You are a Performance Management AI Agent for ResourcefulAI. You have tools to look up and update real performance data.
...
async def query_performance(request: PerformanceQueryRequest):
    try:
        ...
        logger.info(
            f"✅ Performance ReAct complete — {result['iterations']} iteration(s), "
